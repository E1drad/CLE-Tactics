package plugins.plugin.basegame;
...
import framework.publicInterfaces.IGame;
import framework.publicInterfaces.IMap;
import framework.publicInterfaces.IMapDisplay;
import plugins.plugin.baseability.BaseAbilityScore;
import plugins.plugin.baseia.BaseArtificialIntelligence;
import plugins.plugin.baseentity.BaseEntity;
...
public class BaseGame implements IGame{
	...
	public BaseGame() throws InstantiationException, IllegalAccessException {
		...
		this.turn = 0;
		this.map = (IMap) loader.newInstanceof("framework.publicInterfaces.IMap");
		this.characters = new ArrayList<IEntity>();
		this.mapDisplay = (IMapDisplay) loader.newInstanceof("framework.publicInterfaces.IMapDisplay");
		INSTANCE = this;
	}
