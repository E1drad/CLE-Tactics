package plugins.plugin.baseentity;

import java.util.ArrayList;

import framework.ExtensionLoader;
import framework.publicInterfaces.IAbilityScore;
import framework.publicInterfaces.IArtificialIntelligence;
import framework.publicInterfaces.IEntity;
import framework.publicInterfaces.IGameMenu;
import framework.publicInterfaces.IMap;
import plugins.plugin.basegamemenu.BaseGameMenu;
...
public class BaseEntity implements IEntity {
	...
	public BaseEntity() {	
		...
		this.abilityScore = (IAbilityScore) loader.newInstanceof("framework.publicInterfaces.IAbilityScore");
		this.identifier = 0;
		this.team = 0;
